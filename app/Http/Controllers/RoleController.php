...
class RoleController extends Controller
{
    ...
    public function data(){
        if($this->slugpermision()){
            ...
            ->addColumn( 'btnEdit', '<button class="btn btn-verde btn-sm btn-edit-modal" data-id="{{$id}}"><span class="far fa-edit"></span></button>')
            ->addColumn( 'btnDelete', '<button class="btn btn-verde btn-sm btn-delete-modal" data-id="{{$id}}"><span class="fas fa-trash"></span></button>')
    ...
    {   
        if($this->slugpermision()){
            ...
            $permisosroles=Role::join('permissions_role', 'permissions_role.role_id','=','roles.id')
