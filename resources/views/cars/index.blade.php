...
@section('content-sidebar')
    ...
    <!-- Modal insertar-->
    <div class="modal fade bd-example-modal-md" id="modal_car" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
