...
<html >
    ...
    <body style="font-size: 13px">
        <main>
                ...
                <tbody>
                    <tr id="tablaencabezado">
                        <td class="text-center">
                            <img src="img/logo.jpg" style="width: 200px" alt=""></td>
                        <td>
                            <p >
            ...
            <p>Recibí concentrador de oxígeno, dejando un depósito en garantía de $ {{$payment->deposit_garanty}} , dicho deposito será devuelto al momento de la entrega del concentrador.</p>
