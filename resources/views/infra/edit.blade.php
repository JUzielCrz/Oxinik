...
<div class="container">
    <form id="formCreateInfra">
        @csrf
        <input type="hidden" id="idInfraNota" name="idInfraNota" value="{{$infranota->id}}">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6 ">
                                    <label>Fecha</label>
                                    <input class="form-control" type="date" name="fecha" id="fecha" value="{{$infranota->fecha}}">
                                    <span id="fechaError" class="text-danger"></span>
                                </div>
                                <div class="col-md-6">
                                    {!! Form::label('Incidencia') !!}
                                    {{ Form::select('incidencia',['ENTRADA' => 'ENTRADA', 'SALIDA' => 'SALIDA'], $infranota->incidencia ,['id' => 'incidencia','class'=>'form-control ml-2', 'placeholder'=>'Selecciona', 'required'])}}
                ...
                <div class="col-md-3">
                    <div class="card bg-gray" style="height: 10rem;">
                        ...
                        <div class="card-body text-center" style="padding: 0px">
                            ...
                            <input type="hidden" id="cantidadtanques" value="{{$infranota->cantidad}}">
                        </div>
                    </div>
                </div>
            </div>
...
<!--Scripts-->
<script src="{{ asset('js/infra/edit.js') }}"></script>
<!--Fin Scripts-->
