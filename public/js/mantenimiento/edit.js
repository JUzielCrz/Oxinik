$(document).ready(function () {
    ...
    $(document).on("click","#btn-SaveAll", actializar_all);

    var contador=$('#cantidadtanques').val();
    $("#contador").replaceWith("<h1 id='contador' class='display-1' style='font-size: 6rem;'>"+ contador+"</h1>");
    ...
    function actializar_all(){
        ...
        var dataForm= $("#formCreatemantenimiento").serialize()+'&cantidad=' + cantidad;

        $.ajax({
            method: "get",
            url: "/actualizarnotemantenimiento",
            data: dataForm,
        }).done(function(msg){
